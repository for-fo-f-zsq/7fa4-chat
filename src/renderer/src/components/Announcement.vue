    ...
    <div class="announcement-card">
      ...
      <div v-else-if="page === 1" class="announcement-page">
        ...
        <ul class="announcement-list">
          <li>新手引导全新设计，不再遮挡操作，完成由你的真实操作判定，可随时跳过</li>
          <li>聊天输入框支持实时 Markdown 预览</li>
          <li>「工具 → Markdown」编辑器彻底重做，配色自动跟随应用主题</li>
          <li>Markdown 渲染增强，支持更多语法，代码块配色跟随明暗主题</li>
          <li>图片消息判定更合理，仅整条为图片时才作为图片消息显示</li>
          <li>工具页重构：各工具独立成页，从消息打开的工具返回时回到原会话</li>
          <li>修复含图片的长文本消息被错误显示为图片、文字丢失的问题</li>
        </ul>
      </div>
      <!-- 页 3：更新日志 -->
